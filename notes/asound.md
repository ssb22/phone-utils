...
Cons:
* **No longer works on recent Android** (e.g. Android 14: it crashes when Record is pressed). If you need a decibel meter, separate apps are available but are approximate due to phones typically picking up only mid-range frequencies and/or processing too much before the app gets the data
* Closed source
* Small controls
