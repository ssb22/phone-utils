...
from https://ssb22.user.srcf.net/law/whatsapp.html (also [mirrored on GitLab Pages](https://ssb22.gitlab.io/law/whatsapp.html) just in case)

# Unclarity in WhatsApp’s new Terms

On 7<sup>th</sup> January 2021, WhatsApp Messenger asked me to agree to send data to Facebook. I did not.
...
* and I definitely don’t want anybody to be able to trick their system into sending a specific advertisement to my contacts, as in “I don’t like something Silas said, and I’ll get revenge by showing this nasty advert to all his contacts.” When GMail ran advertising based on the content of messages (later withdrawn), I found one overzealous local church member had set ‘attack’ advertisements to be triggered by the *street address* of another religion, who then had to invite their interested ones to events without saying where! Google closed that account when reported, but damage had already been done. We can’t assume a policy with a complaints team can stop all attacks any more than a law with a police force can stop all crime—I’d rather use a system that doesn’t make it easy in the first place.
...
As I had no reply from the dedicated enquiries address posted with the EU Privacy Policy, and the revised 15<sup>th</sup> May deadline drew near without any indication that they were going to fix the wording, I gave notice to all active WhatsApp groups I was in, mostly saying:
...
(This was before Telegram Messenger’s service became restricted to over 18s in UK/EU/AU.)
...
WhatsApp never replied to *me* but on 11<sup>th</sup> May a German official was widely quoted as saying “even after close analysis, it is not clear what consequences approval has for users” and disallowing it in Germany, to which WhatsApp reportedly said “the Hamburg DPA’s claims are wrong” so they “will not impact the continued roll-out of the update” and the wording of the new agreement was not changed.
...
## 2024 and 2026 updates

In 2024, WhatsApp linked UK users to a new “UK” version of their Privacy Policy which includes the following sentence in a discussion of uploading contacts, and it’s still present in the 2026 version:
...
which sounds nice but it doesn’t actually say *what* those “instructions and terms” are, and in particular it doesn’t say “in accordance with this Privacy Policy” so they still have a loophole here.

### “WhatsApp for Business” doesn’t help

Some individuals have suggested that people involved with local community groups etc switch to the “WhatsApp for Business” version of the app, since the WhatsApp Business terms of use say you are the data controller for GDPR purposes.

Unfortunately, those terms of use also say:
* you will not “use our Business Services for personal, family, or household purposes or without applicable business licenses” (and apparently these “Business Services” are, not just a subset of the app’s functionality, but the whole thing),
* and you “must also secure all necessary rights, consents, and permissions (for example, opt-in) to share its customers’ contact and other personal data with WhatsApp” and elsewhere states this will be shared with all Meta companies and used in marketing.

So it seems being “the controller” is merely a more formal way of saying “it’s on you to get all your contacts’ permission for us to use their data before you press Continue” and I suspect a large number of people are in a legally precarious situation with this.

## “Advanced Chat Privacy” rumours in Hong Kong

In 2025 an image ![whatsapp.jpg](https://ssb22.user.srcf.net/law/whatsapp.jpg) started to circulate among the Hong Kong diaspora with text saying “Whats[A]pp group chat is under AI cybersecurity challenges Each [W]hats[A]pp group admin please switch on Advance[d] Chat Privacy otherwise AI will legally [get] access into all group chat members[’] messages and personal H[and]P[hone] n[umbers] [and access] to everyone’s phone. Even 1 to 1 [W]hats[A]pp chat also needs to switch on Advance[d] Chat Privacy as well.”

WhatsApp’s *own* description of that option is that it blocks *your friends* (not WhatsApp) from being able to send your messages to unspecified “AI” features (for summarisation, translation etc) *and* it prevents your friends from being allowed to “export” the chat, hence becoming an obstacle to their migration to a safer platform like Signal.

Since the option has **no effect** on what WhatsApp *itself* can do (only on what your *friends* are allowed to do), and since turning on that option helps to lock more people **in** to WhatsApp by preventing chat export (when people are better off being *able* to export chats so they *can leave* WhatsApp), my recommendation is to refrain from forwarding that image and to leave the Advanced Chat Privacy option turned off. Just seek ways to reduce your use of WhatsApp altogether, at least until WhatsApp can get their policies properly clarified regarding *their* use of your contacts, which is *not* helped by this option—it restricts what your *friends* can do but not what *WhatsApp* can do.

## Limiting WhatsApp’s access to contacts

Using technical means to limit WhatsApp’s access to your phone contacts before accepting the installation agreement does not completely solve the problem: you’d still be giving Facebook/Meta permission to make inferences about any contact information they *do* get—such as the subset of people with whom you do communicate on WhatsApp—even if they’re unable to use the rest of your contact list. And being unable to access your other contacts is *not* a given: the agreement didn’t say Facebook won’t ever try to find a way *around* whatever technical measures you put in, plus accidents happen and once you’ve agreed you’ve agreed.
...
2. Deny the WhatsApp app permission to read any phone contacts. This option became considerably more viable when they implemented the new “WhatsApp Contacts” (enabled under Settings / Privacy / Contacts) and stopped the repeated nags to re-grant permission. However, WhatsApp can’t do an Android Cloud Backup unless you’ve already let connect to a Google account while Contacts access is enabled, which means unless you copy off and clear your phone’s contacts to grant temporary permission you won’t be able to move history to or from an Android Work profile (below) as the system prevents local network transfers between the two virtual devices. (The various historical kludges of restoring from `.crypt14` files don’t work in recent WhatsApp. You can still use Export Chat but it’s limited: likely to error if saved to a file on Work profile, and sharing directly with Telegram omits media and initial messages, and works only for group chats or if you have the individual as a Telegram contact.) Contacts / Settings / Export and Settings / Organise / Delete / Select All at least lets you temporarily clear contacts so you can use WhatsApp’s Settings / Chats / Backup with contacts allowed and a Google account selected (and Automatic backup set to When tapped rather than Never), then restore from this on the other profile before revoking the Contacts permission and restoring the phone’s deleted contacts. Please note this page has a disclaimer: if you make a mistake and unrecoverably delete all your contacts that’s not my liability.
...
4. Set up a “work” profile with cross-profile contacts search disabled, and install WhatsApp on that so it will have access only to “work” contacts. This is an option only if your device is not already enrolled in any organisation’s work profile; you’ll need an app like Test DPC (on Android Enterprise) to set it up, and you’d better be careful when setting both Policy permissions and also Play Store contacts backup/restore options in the profile, *and* when installing other apps to it: for example, if you install Telegram Messenger as a convenience for transferring files in and out of the profile, don’t let *that* try to sync contacts if WhatsApp still has access to the result. However, any input methods or unusual keyboards you require can probably be reinstalled in the “work” profile to save having to copy/paste all text, and you should be able to use Android’s “Share” function to send images and videos *into* the Work WhatsApp although there doesn’t seem to be a user-accessible setting in TestDPC to allow the reverse.
